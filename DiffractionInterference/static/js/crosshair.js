...
function resize_canvas() {
    document.getElementById('chcv').width = document.getElementById('video').clientWidth
    document.getElementById('chcv').height = document.getElementById('video').clientHeight
    document.getElementById('wrapper_v').width = document.getElementById('video').clientWidth
    document.getElementById('wrapper_v').height = document.getElementById('video').clientHeight
}
