from labcontrol import Experiment, StepperI2C, Keithley6514Electrometer, Keithley2000Multimeter#, Relay
import visa
...
potentiometer = StepperI2C("Pot", 2,bounds=(0,2000))

filterWheel = StepperI2C("Wheel", 1, bounds=(-810,0), refPoints=refPoints)
