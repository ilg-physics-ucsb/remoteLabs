from labcontrol import Experiment, StepperI2C, Keithley6514Electrometer, Keithley2000Multimeter, Plug, Stepper
import visa
import pickle
...
filterWheel = Stepper("Wheel", pot_pins, refPoints=refPoints)
